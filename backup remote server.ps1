...
$localFolder = "C:\HOSTED\sdme\sdme-home\public_html"
#$localFolder = "C:\HOSTED\sdme\public_html_test" #test directory
#temp directory for local mirroring

$localTempFolder = "C:\HOSTED\sdme\sdme-temp\ready-for-remote-temp" 
...
$removeFiles = @("*.svn","_windows","codestyles","*.xml","*.cvs", ".idea","*.DS_Store", "*.git", "*.hg", "*.hprof","*.pyc", "*.psd") 
